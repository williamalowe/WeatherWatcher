...
const Card = ({ day, weatherData, current }) => {
  ...
  current
    ? (displayTemp = current.temp_c)
    : (displayTemp = weatherData.day.avgtemp_c);
  if (day === "today") {
    ...
    >
      ...
      >
        <motion.div variants={child}>
          <Header title={day} date={displayDate} />
        </motion.div>
        <motion.div variants={child}>
          <CurrentIcon icon={weatherData.day.condition.icon} />
        </motion.div>
        <motion.div variants={child}>
          <Temperature
        ...
        <motion.div variants={child}>
          <ConditionStatus code={weatherData.day.condition.code} />
        </motion.div>
      </motion.div>
      <div className={styles.lower}>
        {displayColor === "var(--primary-blue)" ? (
          <img src="/bluewave.svg" alt="" />
        ) : displayColor === "var(--primary-green)" ? (
          <img src="/greenwave.svg" alt="" />
        ) : (
          <img src="/orangewave.svg" alt="" />
        )}
        <div className={styles.lower_content}>
          <Forecast weatherData={weatherData} color={displayColor} />
        </div>
      </div>
    </motion.section>
  );
